...
{
	public static var osEngineVersion:String = '1.5.2'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 44, 0, "OS Crisis Engine" + " - Modified OS Engine", 12);
